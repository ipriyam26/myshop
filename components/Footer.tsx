...
function Footer() {
  return (
    <div>
        <footer className="text-gray-400 bg-dark_color-500 body-font">
...
<SiCodesandbox className=' text-5xl'/>
  ...
  <div className="bg-gray-800 bg-opacity-75">
    <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
      <p className="text-gray-400 text-sm text-center sm:text-left">© 2020 Codewear —
        <a href="https://twitter.com/knyttneve" rel="noopener noreferrer" className="text-gray-500 ml-1" target="_blank">@ipriyam</a>
      </p>
